...
<form method='post' class='mt-20px'>
  <table class='table-4' align='center'> 
    <caption class='caption-tl'><?php echo $lang->info->customFields;?></caption>
    <tr class='colhead'>
      <th><?php echo $lang->info->lblAllFields;?></th>
      <th></th>
      <th><?php echo $lang->info->lblCustomFields;?></th>
      <th></th>
    </tr>  
    <tr>
      <td>
      ...
      <td>
        ...
        echo html::commonButton($lang->info->restoreDefault, "onclick=restoreDefault()")  . '<br />';
        ?>
      </td>
    </tr>  
